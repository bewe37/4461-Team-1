...
class Schelling(Model):
    """
    A minimal echo-chamber-style model where bot agents can move to empty cells,
    and humans can adopt disinformation based on bot neighbors.
    """
    ...
    def move_to_empty(self, agent):
        """
        Move the given agent to a randomly chosen empty cell.
        """
        empty_cells = []
        for _, pos in self.grid.coord_iter():
